                                    ...
                                    <tbody>
                                        @foreach ($banners as $banner)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a class="btn btn-info btn-sm" title="Edit Banner" href="{{ url('admin/add-edit-banner/'.$banner['id']) }}"><i class="fas fa-edit"></i> แก้ไข</a>
                                                    &nbsp;&nbsp;
                                                    <a title="Delete Banner" href="javascript:void(0)" class="confirmDelete btn btn-danger btn-sm" record="banner"
                                                        recordid="{{ $banner['id'] }}"><i class="fas fa-trash-alt"></i> ลบ</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
