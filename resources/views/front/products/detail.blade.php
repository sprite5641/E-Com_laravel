                ...
                <div id="differentview" class="moreOptopm carousel slide">
                    <div class="carousel-inner">
                        <div class="item active">
                           ...
                           <a href="{{ asset('images/product_images/small/'.$image['image'])}}"> <img style="width:29%"
                        ...
                        <div class="tab-pane" id="listView">
                            ...
                            <div class="row">
                                ...
                                <div class="span4">
                                    ...
                                    <a class="btn btn-small pull-right" href="{{ url('product/' . $product['id']) }}">ดูเพิ่มเติม</a>
                                    <br class="clr" />
                                </div>
                                <div class="span3 alignR">
                                    <form class="form-horizontal qtyFrm">
                                        ...
                                        <div class="btn-group">
                                            <a href="product_details.html" class="btn btn-large btn-primary"> เพิ่มสินค้า <i
                                    ...
                                    <div class="thumbnail">
                                        ...
                                        <div class="caption">
                                            ...
                                            <h4 style="text-align:center"><a class="btn" href="{{ url('product/' . $product['id']) }}"> <i
                                                    ...
                                                    href="#">ราคา {{ $product['product_price']}} บาท</a></h4>
                                        </div>
                                    </div>
                                </li>
                                @endforeach
